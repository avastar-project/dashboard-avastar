export interface AvastarParsedDataPoint {
  ...
  data_type: string; // same here, maybe there is an enum for this
  data_origin: 'Volunteered' | 'Scraped' | 'ManuallyAdded' | 'Other'; // suggesting by github copilot not sure if accurate
