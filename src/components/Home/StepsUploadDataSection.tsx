      ...
      <StepsList>
        ...
        {steps.map((steps:Steps, index:number) => (
          <StepItem key={index}>
            ...
            <ContentContainer>
             <li><Typography variant='h4'>{steps.name}</Typography></li>
             <li><Typography variant='body1'>{steps.content.p1}</Typography></li>
             <li><Typography variant='body1'>{steps.content.p2}</Typography></li>
             <li><Typography variant='body1'>{steps.content.pItalic}</Typography></li>
            </ContentContainer>
          </StepItem>
        ))}
      </StepsList>
