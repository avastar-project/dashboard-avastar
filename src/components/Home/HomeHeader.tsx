...
export default function Header() {
    ...
    <Container alignItems ='center'>
      ...
      <Grid item xs={8}>
         <Headline1 variant="h2"> Get an immediate overview of your digital footprint & learn how to manage your online privacy.</Headline1>
     </Grid>
     <Grid item xs={4}>
        <BackgroundImage>place holder illustration</BackgroundImage>
     </Grid>
      </Grid>
      <Headline2 variant='body1'> Undersand what your favorite apps know about you and do with your data.</Headline2>
    </Container>
    );
  };